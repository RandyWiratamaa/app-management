...
class ProductSubCategoryController extends Controller
{
    ...
    {
        $product_sub_categories = Http::get(env('URL_PRODUCT_MANAGEMENT').'/api/product-sub-categories');
    ...
    {
        $product_category = Http::get(env('URL_PRODUCT_MANAGEMENT').'/api/product-categories');
    ...
    {
        $res = Http::post(env('URL_PRODUCT_MANAGEMENT').'/api/product-sub-category',[
            'name' => $request->name,
